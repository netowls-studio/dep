...
namespace NetowlsStudio.Dep.Messaging
{
    ...
    public interface IStreamingMessageBuilder
    {
        ...
        IEnumerable<StreamingMessage> Build();
        ...
        /// <seealso cref="StreamingMessage" />
        Task<Tuple<IEnumerable<StreamingMessage>, Exception>> BuildAsync();
        ...
        /// <seealso cref="IStreamSplitter" />
        IStreamingMessageBuilder WithSplitter(IStreamSplitter splitter);
    }
}